...
Wraith ships [143 MCP tools](/docs/mcp-tools) that go far beyond navigation and clicking. This is where the gap between a scripting framework and an agent-native platform becomes obvious.
