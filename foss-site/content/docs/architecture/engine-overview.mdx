...
description: How Wraith Browser's three engine backends work — SevroEngine, NativeEngine, and CdpEngine — and how the BrowserEngine trait unifies them behind a single async interface.
---
...
- **CI/CD pipelines:** No need to install Chrome in Docker images. The Wraith binary is
  self-contained.
