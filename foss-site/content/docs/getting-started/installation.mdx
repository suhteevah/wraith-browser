...
```text
   Compiling openclaw-browser-core v0.1.0
   Compiling openclaw-content-extract v0.1.0
   Compiling openclaw-cache v0.1.0
   Compiling openclaw-identity v0.1.0
   Compiling openclaw-mcp-server v0.1.0
   Compiling openclaw-search v0.1.0
   Compiling openclaw-agent-loop v0.1.0
   Compiling openclaw-cli v0.1.0
