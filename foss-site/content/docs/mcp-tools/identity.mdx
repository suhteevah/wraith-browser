...
description: Browser fingerprints, identity profiles, site technology detection, and stealth status
---

Identity tools control how OpenClaw Browser presents itself to websites. You can switch between browser fingerprint profiles, set personal or anonymous identity modes, detect a site's technology stack, and verify your TLS fingerprint matches a real Chrome browser.
...
| `stealth_status` | Show current TLS compatibility and evasion config | *(none)* |
